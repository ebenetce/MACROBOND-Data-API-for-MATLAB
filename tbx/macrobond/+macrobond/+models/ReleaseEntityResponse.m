classdef ReleaseEntityResponse < macrobond.JSONMapper
% ReleaseEntityResponse A release entity
% 
% ReleaseEntityResponse Properties:
...
%   xevents - The schedule of the release or not specified if the schedule is not known of if there was an error - type: array of ReleaseEventItem
...
% MATLAB Generator for OpenAPI version: 1.0.0
    ...
    properties
        ...
        % xevents - The schedule of the release or not specified if the schedule is not known of if there was an error - type: array of ReleaseEventItem
        xevents macrobond.models.ReleaseEventItem { macrobond.JSONMapper.fieldName(xevents,"events"), macrobond.JSONMapper.JSONArray}
    end

    % Class methods
    methods
        % Constructor
        function obj = ReleaseEntityResponse(s,inputs)
            ...
            arguments
                ...
                inputs.?macrobond.models.ReleaseEntityResponse
            end
